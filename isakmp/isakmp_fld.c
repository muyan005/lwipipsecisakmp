...
struct constant_map *isakmp_hdr_next_payload_maps[] = {
	isakmp_payload_cst, 0
};
struct constant_map *isakmp_hdr_flags_maps[] = {
	isakmp_flags_cst, 0
};
struct constant_map *isakmp_hdr_exch_type_maps[] = {
	ike_exch_cst,isakmp_exch_cst, 0
};
...
struct constant_map *isakmp_gen_next_payload_maps[] = {
	isakmp_payload_cst, 0
};
...
struct constant_map *isakmp_attr_type_maps[] = {
	ike_attr_cst,ipsec_attr_cst, 0
};
...
struct constant_map *isakmp_sa_doi_maps[] = {
	isakmp_doi_cst,ipsec_doi_cst, 0
};
...
struct constant_map *isakmp_prop_proto_maps[] = {
	isakmp_proto_cst,ipsec_proto_cst, 0
};
...
struct constant_map *isakmp_cert_encoding_maps[] = {
	isakmp_certenc_cst, 0
};
...
struct constant_map *isakmp_certreq_type_maps[] = {
	isakmp_certenc_cst, 0
};
...
struct constant_map *isakmp_notify_msg_type_maps[] = {
	isakmp_notify_cst,ipsec_notify_cst, 0
};
struct constant_map *isakmp_notify_proto_maps[] = {
	isakmp_proto_cst, 0
};
struct constant_map *isakmp_notify_doi_maps[] = {
	isakmp_doi_cst,ipsec_doi_cst, 0
};
...
struct constant_map *isakmp_delete_proto_maps[] = {
	isakmp_proto_cst, 0
};
...
struct constant_map *isakmp_attribute_type_maps[] = {
	isakmp_cfg_cst, 0
};

struct field isakmp_nat_d_fld[] = {
	{ "DATA", 4, 0, raw, 0 },
	{ 0, 0, 0, 0, 0 }
};


struct field isakmp_nat_oa_fld[] = {
	{ "TYPE", 4, 1, num, 0 },
	{ "RESERVED", 5, 3, ign, 0 },
	{ "DATA", 8, 0, raw, 0 },
	{ 0, 0, 0, 0, 0 }
